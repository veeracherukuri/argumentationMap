...
@RestController
@RequestMapping("/api/argumentation-map-kafka")
public class ArgumentationMapKafkaResource {
    private final Logger log = LoggerFactory.getLogger(ArgumentationMapKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ArgumentationMapKafkaResource(KafkaProperties kafkaProperties) {
