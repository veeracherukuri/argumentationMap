...
class ArgumentationMapKafkaResourceIT {
    ...
    void setup() {
        ...
        ArgumentationMapKafkaResource kafkaResource = new ArgumentationMapKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/argumentation-map-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/argumentation-map-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
